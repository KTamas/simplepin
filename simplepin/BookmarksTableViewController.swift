        ...
        if longPressGestureRecognizer.state == UIGestureRecognizer.State.began {
            ...
            if let indexPath = tableView.indexPathForRow(at: touchPoint) {
                ...
                func actionReadUnread(toread: Bool) -> UIAlertAction {
                    ...
                    let action = UIAlertAction(title: "Mark as \(title)", style: UIAlertAction.Style.default, handler: { _ in
                ...
                let actionEdit = UIAlertAction(title: "Edit", style: UIAlertAction.Style.default, handler: { _ in
                    self.bookmarkToPass = bookmark
                    self.performSegue(withIdentifier: "openEditBookmarkModal", sender: self)
                })
                let actionDelete = UIAlertAction(title: "Delete", style: UIAlertAction.Style.destructive, handler: { _ in
